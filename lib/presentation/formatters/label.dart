...
FONTSIZE 12
PT "NAO UTILIZAR"
PP206,81:PT "MATERIAL REJEITADO"
PP335,591:NI
FONTSIZE 7
PT "Op"
PP394,41:FONTSIZE 10
PT "${pn}"
PP468,40:FONTSIZE 7
PT "Classificacao"
PP514,38:FONTSIZE 10
PT "${classificacaoParts[0]}"
PP586,38:PT "${classificacaoParts[1]}"
PP658,39:FONTSIZE 7
PT "Motivo de rejeicao"
PP888,36:FONTSIZE 10
PT "${obsParts[0]}"
PP960,36:PT "${obsParts[1]}"
PP841,37:FONTSIZE 7
PT "Observacao"
PP1088,37:FONTSIZE 10
PT "${req}"
PP1037,38:FONTSIZE 7
PT "Requisicao"
PP1032,264:PT "Quantidade"
PP340,42:PT "Part number"
PP702,38:FONTSIZE 10
PT "${motivoParts[0]}"
PP774,38:PT "${motivoParts[1]}"
PP1078,268:PT "${qtd}"
PP333,574:AN1
DIR1
PL127,6
...
DIR4
PT "${data}"
PP1033,504:FONTSIZE 7
PT "Data"
PP1173,181:BARSET "CODE128B",2,1,4,96
PB "${pn}"
LAYOUT RUN ""
PF
PRINT KEY OFF
